...
model: inherit
skills: clean-code, deployment-procedures, server-management, powershell-windows, bash-linux, ci-cd-and-automation, shipping-and-launch, observability-and-instrumentation
---
