...
| **Marketing** | marketing-specialist, frontend-specialist, seo-specialist |
| **Studio** | frontend-specialist, image-prompt-engineer, marketing-specialist |
...
## Available Agents (19 + 2 new = 21 total)
...
| `marketing-specialist` | Marketing | Ad copy, campaigns, growth |
| `image-prompt-engineer` | Visual | AI image prompts, photography |
...
### Step 4: Context Engineering (from GSD)

Má»—i orchestration task PHáº¢I táº¡o cÃ¡c file context:

| File | Ná»™i dung | Khi nÃ o |
|------|---------|--------|
| `docs/PLAN.md` | Task breakdown + verification | Phase 1 |
| `docs/STATE.md` | Quyáº¿t Ä‘á»‹nh, blockers, vá»‹ trÃ­ hiá»‡n táº¡i | XuyÃªn suá»‘t |
| `docs/CONTEXT.md` | User preferences cho phase hiá»‡n táº¡i | Phase 2 |
| `docs/SUMMARY.md` | Káº¿t quáº£ má»—i phase | Sau má»—i phase |

> ðŸ”´ **STATE.md** lÃ  bá»™ nhá»› xuyÃªn session. LuÃ´n cáº­p nháº­t sau má»—i bÆ°á»›c.
...
### Step 6: Atomic Git Commits (from GSD)
Má»—i task = 1 commit riÃªng:
```bash
abc123f docs(phase-1): create project plan
def456g feat(phase-1): implement auth flow  
hij789k test(phase-1): add auth unit tests
```
> Má»—i commit cÃ³ thá»ƒ revert Ä‘á»™c láº­p. `git bisect` tÃ¬m Ä‘Ãºng task lá»—i.
